...
int main(int argc, char** argv)
{
    ...
    VulkanFrameResources* frame_resources = vulkan_frame_resources_init(renderer);
    if (frame_resources == nullptr)
    {
        return 1;
    }
    ...
    vulkan_frame_resources_destroy(renderer, frame_resources);
